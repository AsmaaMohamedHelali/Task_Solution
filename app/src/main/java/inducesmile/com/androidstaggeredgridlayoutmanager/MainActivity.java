...
//             Showing progress dialog
        ...
        protected List<ItemObjects> doInBackground(Void... arg0) {
            ...
            String jsonStr = servicehandler.makeServiceCall(SERVICE_URL + COUNT + "=10&" + FROM + "="+from, ServiceHandler.GET);
            if(jsonStr!=null){
                Bitmap bitmap=null;
                JSONArray jsonarr;
                ...
                try {
                    ...
                    if (jsonarr.length() != 0) {
                        for (int i = 0; i < jsonarr.length(); i++) {
                            ...
                            String pr_desc = jsonobj.getString(PRODUCT_DESC);
                            String pr_price = jsonobj.getString(PRODUCT_PRICE);
        ...
        protected void onPostExecute(List<ItemObjects> result) {
            ...
            List<ItemObjects> gaggeredList = result;
